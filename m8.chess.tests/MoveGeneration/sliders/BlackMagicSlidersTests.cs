...
public class BlackMagicSlidersTests
{
    [Fact]
    public void GetRooksAttacks_E4EmptyBoard_CorrectAttacksReturned()
    {
        ...
        var actual = BlackMagicSliders.GetRooksAttacks(Square.e4, Bitboard.Empty);
    ...
    public void GetRooksAttacks_E4EdgeOfBoardOccupied_CorrectAttacksReturned()
    {
        ...
        var actual = BlackMagicSliders.GetRooksAttacks(Square.e4, occupancy);
    ...
    public void GetBishopAttacks_E4EmptyBoard_CorrectAttacksReturned()
    {
        ...
        var actual = BlackMagicSliders.GetBishopAttacks(Square.e4, Bitboard.Empty);
    ...
    public void GetBishopAttacks_E4EdgeOfBoardOccupied_CorrectAttacksReturned()
    {
        ...
        var actual = BlackMagicSliders.GetBishopAttacks(Square.e4, occupancy);
